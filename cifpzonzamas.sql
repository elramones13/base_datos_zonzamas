...
CREATE OR REPLACE RULE actu_cursos_ciclos1 AS ON UPDATE TO alumnos where NEW.id_profesor = 1  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 1), (NEW.id_copy, 2), (NEW.id_copy, 3), (NEW.id_copy, 4), (NEW.id_copy, 5), (NEW.id_copy, 6);
CREATE OR REPLACE RULE actu_cursos_ciclos2 AS ON UPDATE TO alumnos where NEW.id_profesor = 2  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 7), (NEW.id_copy, 8), (NEW.id_copy, 9), (NEW.id_copy, 10), (NEW.id_copy, 11);
CREATE OR REPLACE RULE actu_cursos_ciclos3 AS ON UPDATE TO alumnos where NEW.id_profesor = 3  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 12), (NEW.id_copy, 13), (NEW.id_copy, 14), (NEW.id_copy, 15), (NEW.id_copy, 16), (NEW.id_copy, 17), (NEW.id_copy, 18);
CREATE OR REPLACE RULE actu_cursos_ciclos4 AS ON UPDATE TO alumnos where NEW.id_profesor = 4  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 19), (NEW.id_copy, 20), (NEW.id_copy, 21), (NEW.id_copy, 22), (NEW.id_copy, 23), (NEW.id_copy, 24);
CREATE OR REPLACE RULE actu_cursos_ciclos5 AS ON UPDATE TO alumnos where NEW.id_profesor = 5  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 25), (NEW.id_copy, 26), (NEW.id_copy, 27), (NEW.id_copy, 28), (NEW.id_copy, 29);
CREATE OR REPLACE RULE actu_cursos_ciclos6 AS ON UPDATE TO alumnos where NEW.id_profesor = 6  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 30), (NEW.id_copy, 31), (NEW.id_copy, 32), (NEW.id_copy, 33), (NEW.id_copy, 34);
CREATE OR REPLACE RULE actu_cursos_ciclos7 AS ON UPDATE TO alumnos where NEW.id_profesor = 7  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 35), (NEW.id_copy, 36), (NEW.id_copy, 37), (NEW.id_copy, 38), (NEW.id_copy, 39), (NEW.id_copy, 40);
CREATE OR REPLACE RULE actu_cursos_ciclos8 AS ON UPDATE TO alumnos where NEW.id_profesor = 8  DO ALSO insert into alumnos_modulos (id_alumno, id_modulo) VALUES (NEW.id_copy, 41), (NEW.id_copy, 42), (NEW.id_copy, 43), (NEW.id_copy, 44), (NEW.id_copy, 45), (NEW.id_copy, 46);

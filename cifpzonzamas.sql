...
insert into alumnos (nombre, apellido1, apellido2, fecha_nacimiento, email, telefono, sexo, pais,repetidor, id_curso_ciclo, curso_escolar) values ('Ransom', 'Gascard', 'Kennefick', '19861104', 'rkennefick2x@clickbank.net', '2454748812', 'M', 'BR', false,21);
insert into alumnos (nombre, apellido1, apellido2, fecha_nacimiento, email, telefono, sexo, pais,repetidor, id_curso_ciclo, curso_escolar) values ('Vernor', 'Blabber', 'De Gouy', '20000709', 'vdegouy2y@erecht24.de', '3877391612', 'M', 'PA', false,21);
...
insert into alumnos (nombre, apellido1, apellido2, fecha_nacimiento, email, telefono, sexo, pais,repetidor, id_curso_ciclo, curso_escolar) values ('Orin', 'Atmore', 'O''Shee', '19840817', 'ooshee56@imdb.com', '3285593647', 'M', 'CN', false, 2020,22);

...
CREATE OR REPLACE RULE actu_cursos_ciclos1 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 1  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos2 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 2  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos3 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 3  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos4 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 4  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos5 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 5  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos6 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 6  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos7 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 7  DO ALSO insert into alumnos_modulo>
CREATE OR REPLACE RULE actu_cursos_ciclos8 AS ON UPDATE TO alumnos where NEW.id_curso_ciclo = 8  DO ALSO insert into alumnos_modulo>
